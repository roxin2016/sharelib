...
import com.zsyj.sharesdk.download.db.FileDAOImpl;
import com.zsyj.sharesdk.download.entity.FileInfo;
import com.zsyj.sharesdk.download.helper.ListenerDecorator;
import com.zsyj.sharesdk.download.service.DownloadTask;
import com.zsyj.sharesdk.download.service.DownloadThreadPool;
...
public class FileDownloader {
    ...
    public static void init(Context context,String path) {
        sContext = context;
        sConfig = new DownloadConfig.Builder(path).build();
     ...
     * @return
     */
    public static String getRemoveLogDownloadDir() {
        return sConfig.getRemoveLogDownloadDir();
    }
    /**
     * 获取路径
     *
    ...
    public static void start(String url, String name, DownloadListener listener, boolean callBackInMainThread, boolean isRemoveLog) {
        start(new FileInfo(url, name, isRemoveLog), listener, callBackInMainThread);
    }
