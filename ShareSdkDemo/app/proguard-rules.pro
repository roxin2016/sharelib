...
-keep class com.zsyj.wallpaper.bean.** { *; }
-keep class com.zsyj.wallpaper.module.message.bean.** { *; }
-keep class com.zsyj.sharesdk.bean.** { *; }
#-------------------------------------------------------------------------
...
#EpMedia
-keep class com.joe.joevideolib.** { *; }
-keep class Jni.** { *; }
...
-keep class com.zsyj.wallpaper.lib.** { *; }

-keep class afu.org.checkerframework.checker.** { *; }
